  ...
  <svg xmlns="http://www.w3.org/2000/svg"
    ...
    <g>
      <g>
        ...
        <path class="svg-fill" d="M1234.3,1660.7c-42.9-52.3-84.3-100.2-149.5-169.7c-55.1,63.1-105.6,111.7-147.4,161.1
        ...
        <path class="svg-fill" d="M979.9,1405.5c4.8-5.5,4.8-13.6,0-19.1l-127.2-130.1l-27.4-25.9c-22,25.6-42.6,52.4-61.6,80.4
        ...
        <path class="svg-fill" d="M1082.6,363.4C487.3,363.2,4.6,845.6,4.4,1440.8s482.2,1078,1077.4,1078.2
